...
(function( $ ){$.fn.simpleryHelp = function() {
	...
	if (help.is('div'))
		...
		galery.append('<div class="simplery-help"><div class="simplery-help-bg"></div><table>'
			...
			+ '<tr><td class="simplery-help-info" colspan="2"><a href="http://simonnickel.de/devlog/projekte/simplery">simplery</a> by <a href="http://twitter.com/simonnickel">@simonnickel</a> | <a href="https://github.com/simonnickel/simplery">GitHub</a></td></tr>'
			+ '</ul></div>');
